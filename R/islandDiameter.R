#Here, we calculate statistics on the island diameter: either the lowest or 
#the mean diameter in the x-y directions. For each cell, 
#that means the minimum of the number of columns and the number of rows that it
#distributes over.
