...
manner, so that each files lowest and highest values are set to 0 and 1, but
it is much preferred if files with the original intensities are saved, as this 
